...
proc sort data=c192_id out=map_data;
by descending deaths;
run;
...
pattern2 value=solid color='CX80BDBA'; ****green6****;
pattern3 value=solid color='CXE4F1EA'; ****palegreen10****;
pattern4 value=solid color=orange; ****palered11****;
pattern5 value=solid color=maroon; ****palered11****;
pattern6 value=solid color='CXBF1C1C'; ****red0 redbrown****;

proc format;
  value deaths 0   = '0 or unknown'
               1 - 50 = '1 - 50'
               50 - 100 = '51 - 100'
               101 - 500 = '101 - 500'
               501-2000 = '501 - 2000'
...
legend1 label =(f="albany amt/bold" position=top j=l h=12pt "Deaths")
 ...
 ;
title "Covid 19 deaths in US by County";
title2 "Date : &dt";
...
id div;
choro deaths / cdefault=green legend=legend1 discrete coutline = lightgray name="&name";
